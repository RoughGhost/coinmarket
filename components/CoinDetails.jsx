...
const styles = {
  ...
  borderLeft: `ml-10 pl-5 w-full border-1 border-gray-500`,
...
const CoinDetails = ({ coinName, price, coinSymbol }) => {
  const coinIcon = () => {
    switch (coinName) {
      case 'Bitcoin':
        return (
            ...
            <div className={styles.coinInfo}>
              ...
              <div className={styles.borderLeft}>
                <div>
                  ...
                  <small>$58, 900, 290, 500</small>
                  <Rate isIncrement={true} rate="0.70%" />
                </div>
                <br />
                <div>
                  <div>
